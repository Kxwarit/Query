WITH latest_visits AS (
    ...
    LEFT JOIN (SELECT icode, vn, drugusage, qty, hos_guid FROM opitemrece ) op ON op.vn = o.vn
    ...
    GROUP BY p.hn, o.vstdate, os.bmi, os.waist ,os.bps, os.bpd, os.bw, os.height
    ORDER BY p.hn, o.vstdate 
...
pl.urine, pd.bw,pd.height, pd.bmi, pd.pressure, pd.waist, ld.bw,ld.height, ld.bmi, ld.pressure, ld.waist
